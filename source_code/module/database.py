...
class Database:
    def connect(self):
        return pymysql.connect(host='127.0.0.1',user=mysqluser,password=mysqlpassword,db='crud_flask',port=3306,charset='utf8mb4',cursorclass=pymysql.cursors.DictCursor)
